...
Elm.Dog.make = function (_elm) {
   ...
   var returnEle = function (sprite) {
      return A4($Graphics$Element.croppedImage,{ctor: "_Tuple2",_0: sprite.current_x,_1: sprite.current_y},40,40,sprite.image);
   };
   var advance = function (sprite) {
      return _U.cmp(sprite.current_x,sprite.x_dim - 80) < 0 ? _U.update(sprite,{current_x: sprite.current_x + 40}) : _U.update(sprite,
      {current_x: sprite.starting_x});
   };
   var update = F2(function (action,s) {
      var s$ = function () {    var _p0 = action;return advance(s);}();
      return {ctor: "_Tuple2",_0: s$,_1: $Effects.none};
   });
   var view = F2(function (address,s) {
      var onInput = F2(function (address,contentToValue) {
         return A3($Html$Events.on,"input",$Html$Events.targetValue,function (_p1) {    return A2($Signal.message,address,contentToValue(_p1));});
      });
      return A2($Html.div,_U.list([]),_U.list([$Html.fromElement(returnEle(s))]));
   });
   var dogSheet = {image: "dogSheet.png",x_dim: 400,y_dim: 120,starting_x: 88,starting_y: 9,current_x: 88,current_y: 7,rows: 3,columns: 10};
   var Sprite = F9(function (a,b,c,d,e,f,g,h,i) {
      return {image: a,x_dim: b,y_dim: c,starting_x: d,starting_y: e,current_x: f,current_y: g,rows: h,columns: i};
   });
   var Tick = function (a) {    return {ctor: "Tick",_0: a};};
